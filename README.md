...
*This is not path following but point reference following, where the point referece moves along the sircular path. This is why the drone follows the path on the inside.*
---
